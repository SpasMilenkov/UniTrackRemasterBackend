...
namespace UniTrackRemaster.Data.Migrations
{
    ...
    [Migration("20250128213454_MoveFromTPHModelToSeparateTablesInEducationalInstitutions")]
    partial class MoveFromTPHModelToSeparateTablesInEducationalInstitutions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UniTrackRemaster.Data.Models.Organizations.EducationalInstitution", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("UniTrackRemaster.Data.Models.Organizations.School", b =>
                {
                    b.HasBaseType("UniTrackRemaster.Data.Models.Organizations.EducationalInstitution");
            ...
            modelBuilder.Entity("UniTrackRemaster.Data.Models.Academical.AcademicYear", b =>
                {
                    b.HasOne("UniTrackRemaster.Data.Models.Organizations.EducationalInstitution", "EducationalInstitution")
                        .WithMany()
            ...
            modelBuilder.Entity("UniTrackRemaster.Data.Models.Events.Event", b =>
                {
                    b.HasOne("UniTrackRemaster.Data.Models.Organizations.EducationalInstitution", null)
                        .WithMany("Events")
                        .HasForeignKey("EducationalInstitutionId");
            ...
            modelBuilder.Entity("UniTrackRemaster.Data.Models.Organizations.Application", b =>
                {
                    b.HasOne("UniTrackRemaster.Data.Models.Organizations.EducationalInstitution", "Institution")
                        .WithMany()
                        .HasForeignKey("InstitutionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("UniTrackRemaster.Data.Models.Organizations.School", b =>
                {
                    b.HasOne("UniTrackRemaster.Data.Models.Organizations.EducationalInstitution", null)
                        .WithOne()
                        .HasForeignKey("UniTrackRemaster.Data.Models.Organizations.School", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("UniTrackRemaster.Data.Models.Organizations.University", b =>
                {
                    b.HasOne("UniTrackRemaster.Data.Models.Organizations.EducationalInstitution", null)
                        .WithOne()
                        .HasForeignKey("UniTrackRemaster.Data.Models.Organizations.University", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
